...
class OCRCharRecognit:
    ...
    def recognize_char(self,top_left_region:tuple=None,bottom_left_region:tuple=None,threshold=0.3)->list:
        """
        识别屏幕指定区域,返回文字和位置
        :param top_left_region: 截图区域的左上角坐标
        :param bottom_left_region: 截图区域的右下角坐标
        :param threshold: 相似度=置信度,默认文字识别0.3以上，扫不到调0
